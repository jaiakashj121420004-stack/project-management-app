 ...
 */
/** Default text color per theme — mirrors --fg in styles/index.css, used to
 *  fill in the "other side" when only bg OR text has been customized, so the
 *  contrast check below is always comparing two real colors. */
...
export function SettingsPage() {
  ...
  // Re-apply + persist on every change (cheap; these are rare, deliberate edits).
  useEffect(() => {
