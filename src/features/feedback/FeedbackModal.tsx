...
/**
 * Lets any signed-in user send feedback or a feature idea. A segmented kind
 * toggle plus a Zod-validated message; on success it swaps to a thank-you state.
...
export function FeedbackModal({ open, onClose }: FeedbackModalProps) {
  ...
  return (
    <Modal
      ...
      onClose={handleClose}
      accent="aurora"
      title={sent ? undefined : 'Share your thoughts'}
      description={
        sent ? undefined : 'Tell us what you love, what is missing, or what to build next.'
      }
    >
      {sent ? (
        <div className="flex flex-col items-center gap-4 py-6 text-center">
          ...
          <div>
            ...
            <p className="mt-1 text-sm text-fg-muted">
              Your input shapes where Aurora goes next.
            </p>
          </div>
          <GradientButton onClick={handleClose} className="mt-1">
            Done
          </GradientButton>
        </div>
      ) : (
